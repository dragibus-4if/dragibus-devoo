...
public class TSP {
     ...
     * SOLUTION_FOUND, if a tour lower than <code>bound</code> has been found,
     * but its optimality has not been proven within <code>timeLimit</code>
     * milliseconds,<br>
     * OPTIMAL_SOLUTION_FOUND, if a tour lower than <code>bound</code> has been
     * found, and its optimality has been proven,<br>
     ...
     * solution
     * @throws NullPointerException If <code>this.getSolutionState()</code> not
     * in <code>{SOLUTION_FOUND, OPTIMAL_SOLUTION_FOUND}</code>
     */
     ...
     * call to solve,<br>
     * SOLUTION_FOUND if a solution has been found during the last call to solve
     * but its optimality has not been proven,<br>
     * OPTIMAL_SOLUTION_FOUND if a solution has been found during the last call
     * to solve, and its optimality proven,<br>
     * INCONSISTENT if the last call to solve has proven that the problem does
     * not have a solution.
     */
