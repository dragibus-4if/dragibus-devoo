...
\begin{appendices}
    ...
    \begin{itemize}[label = \textbullet, font = \color{orange}]
        ...
        % Ça sert à rien tout ça, non ?
        %\item \underline{Google Drive :}
        %\item \underline{WriteLaTeX :}
        %\item \underline{LucidChart :}
        %\item \underline{Dia :}
        %\item \underline{VisualParadigm :}
        %\item \underline{Trello :}
        %\item \underline{Choco :}
        %\item \underline{SwingX :}
        %\item \underline{Ini4j :}
    \end{itemize}
